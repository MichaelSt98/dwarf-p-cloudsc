...
MODULE CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE_MOD
  ...
  USE CLOUDSC_GPU_SCC_CUF_DEVICE_ALLOCATE_MOD, ONLY: CLOUDSC_SCC_CUF_DEVICE_ALLOCATE
...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE( &
    ...
    INTEGER(kind=cuda_count_kind) :: val_cudaLimitStackSize
    INTEGER(kind=cuda_count_kind) :: val_cudaLimitMallocHeapSize
    INTEGER(kind=cuda_count_kind) :: set_cudaLimitMallocHeapSize
...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    set_cudaLimitMallocHeapSize = 10 * 1024 * 1024 * 1024
    ISTAT = cudaDeviceSetLimit(cudaLimitMallocHeapSize, set_cudaLimitMallocHeapSize)

    ISTAT = cudaDeviceGetLimit(val_cudaLimitStackSize, cudaLimitStackSize)
    print *, "cudaLimitStackSize: ", val_cudaLimitStackSize

    ISTAT = cudaDeviceGetLimit(val_cudaLimitMallocHeapSize, cudaLimitMallocHeapSize)
    print *, "cudaLimitMallocHeapSize: ", val_cudaLimitMallocHeapSize

    !cudaDeviceSetLimit(1000, cudaLimitMallocHeapSize)

    !ISTAT = cudaDeviceSetLimit(cudaLimitMallocHeapSize, 128*1024*1024);
    ...
    CALL CLOUDSC_SCC_CUF_DEVICE_ALLOCATE<<<GRIDDIM,BLOCKDIM >>> &
  ...
  END SUBROUTINE CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE

END MODULE CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE_MOD
