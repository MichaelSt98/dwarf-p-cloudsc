...
#ifdef CLOUDSC_GPU_SCC_CUF_DEVICE_ALLOCATE
USE CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE
#endif

#ifdef CLOUDSC_GPU_SCC_CUF_HOST_ALLOCATE
USE CLOUDSC_DRIVER_GPU_SCC_CUF_HOST_ALLOCATE_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_CUF_HOST_ALLOCATE
#endif
...
print '(1X,A46)', 'Executing CLOUDSC-GPU, "SCC-CUF" CUDA variant...'
 ...
 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_SCC_CUF(NUMOMP, NPROMA, NGPTOT, GLOBAL_STATE%NBLOCKS, NGPTOTG, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
     & GLOBAL_STATE%PVFA,    GLOBAL_STATE%PVFL,  GLOBAL_STATE%PVFI, &
...
#ifdef CLOUDSC_GPU_SCC_CUF_DEVICE_ALLOCATE
print '(1X,A46)', 'Executing CLOUDSC-GPU, "SCC-CUF-DEVICE-ALLOCATE" CUDA variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_SCC_CUF_DEVICE_ALLOCATE(NUMOMP, NPROMA, NGPTOT, GLOBAL_STATE%NBLOCKS, NGPTOTG, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
     & GLOBAL_STATE%PVFA,    GLOBAL_STATE%PVFL,  GLOBAL_STATE%PVFI, &
...
#ifdef CLOUDSC_GPU_SCC_CUF_HOST_ALLOCATE
print '(1X,A46)', 'Executing CLOUDSC-GPU, "SCC-CUF-HOST-ALLOCATE" CUDA variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_SCC_CUF_HOST_ALLOCATE(NUMOMP, NPROMA, NGPTOT, GLOBAL_STATE%NBLOCKS, NGPTOTG, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
     & GLOBAL_STATE%PVFA,    GLOBAL_STATE%PVFL,  GLOBAL_STATE%PVFI, &
